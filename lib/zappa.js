(function() {
  var App, MessageHandler, RequestHandler, Zappa, build_msg, coffee, coffeekup, coffeescript_support, express, fs, io, jquery, parse_msg, publish_api, puts, scoped, sys, z, zappa;
