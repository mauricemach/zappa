(function() {
  ...
  App.prototype.start = function() {
    ...
    if (typeof io !== "undefined" && io !== null) {
      if (!(typeof (_ref = this.ws_server) !== "undefined" && _ref !== null)) {
      ...
      this.ws_server.on('connection', __bind(function(client) {
        var _ref2;
        if (typeof (_ref2 = this.wss.connection) !== "undefined" && _ref2 !== null) {
          return this.wss.connection({}, {
            app: this.vars,
            client: client,
            id: client.sessionId
          });
      ...
      this.ws_server.on('clientDisconnect', __bind(function(client) {
        var _ref2;
        if (typeof (_ref2 = this.wss.disconnection) !== "undefined" && _ref2 !== null) {
          return this.wss.disconnection({}, {
            app: this.vars,
            client: client,
            id: client.sessionId
          });
      ...
      this.ws_server.on('clientMessage', __bind(function(raw_msg, client) {
        ...
        return this.msgs[msg.title].execute(client, msg.params);
      }, this));
    }
  ...
  App.prototype.at = function(pairs) {
    ...
    for (k in _ref) {
      if (!__hasProp.call(_ref, k)) continue;
      v = _ref[k];
      _result.push(this.wss[k] = scoped(v));
    }
    return _result;
  };
  App.prototype.msg = function(pairs) {
    ...
    for (k in _ref) {
      if (!__hasProp.call(_ref, k)) continue;
      v = _ref[k];
      _result.push(this.msgs[k] = new MessageHandler(v, this.defs, this.helpers, this.postrenders, this.views, this.layouts, this.vars));
    }
    return _result;
  };
  ...
  RequestHandler.prototype.build_locals = function() {
    var _i, _ref, k, v;
    this.locals = {};
  ...
  RequestHandler.prototype.render = function(what, postrender_name) {
    var inner, layout, postrender, view;
    layout = this.layouts['default'];
    if (typeof what === 'function') {
      view = what;
    } else {
      view = this.views[what];
    }
    inner = coffeekup.render(view, {
      context: this.context
    });
    if (postrender_name) {
      postrender = this.postrenders[postrender_name];
  ...
  MessageHandler.prototype.build_locals = function() {
    var _i, _ref, k, v;
    this.locals = {};
    this.locals.app = this.vars;
    this.locals.render = this.render;
  ...
  MessageHandler.prototype.render = function(what, postrender_name) {
    var inner, layout, postrender, view;
    layout = this.layouts['default'];
    if (typeof what === 'function') {
      view = what;
