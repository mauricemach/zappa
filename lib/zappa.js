(function() {
  var App, MessageHandler, RequestHandler, Zappa, build_msg, coffee, coffeekup, contains, express, fs, io, js_from_file, jsdom, new_doc, parse_msg, publish_api, puts, read_file, scoped, sys, zappa;
  ...
  Zappa.version = '0.1.1';
  Zappa.app_api = 'get|post|put|del|route|at|msg|client|using|def|helper|postrender|layout|view|style'.split('|');
  ...
  Zappa.prototype.run = function(path, options) {
    var _ref, _ref2, _result, i, js, k, opts, v;
    options = (typeof options !== "undefined" && options !== null) ? options : {};
    if (options.port) {
      options.port = contains(options.port, ',') ? options.port.split(',') : [parseInt(options.port)];
    }
    js = contains(path, '.coffee') ? js_from_file(path) : read_file(path);
    ...
    for (k in _ref) {
      ...
      _result.push((function() {
        opts = {};
        if (options.port) {
          opts.port = (typeof (_ref2 = options.port[i]) !== "undefined" && _ref2 !== null) ? options.port[i] : v.port + i;
        } else if (i !== 0) {
          opts.port = v.port + i;
        }
        v.start(opts);
  ...
  App = function() {
    ...
    this.http_server.configure(__bind(function() {
      ...
      return this.http_server.use(express.bodyDecoder());
    }, this));
    this.vars = {};
    this.defs = {};
    this.helpers = {};
  ...
  RequestHandler.prototype.render = function(what, options) {
    ...
    options = (typeof options !== "undefined" && options !== null) ? options : {};
    options.layout = (typeof options.layout !== "undefined" && options.layout !== null) ? options.layout : true;
